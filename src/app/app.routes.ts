...
export const routes: Routes = [
  ...
  {
    path: 'niveles/:id',
    loadComponent: () => import('./features/niveles/nivel-detail.component').then(m => m.NivelDetailComponent),
  },
  {
    path: 'instituciones',
  ...
  },
  {
    ...
    loadComponent: () => import('./features/instituciones/institucion-detail.component').then(m => m.InstitucionDetailComponent),
  },
  {
    path: 'cargos',
  ...
  {
    path: 'cargos/:id',
    loadComponent: () => import('./features/cargos/cargo-detail.component').then(m => m.CargoDetailComponent),
  },
  {
    path: 'turnos',
  ...
  {
    path: 'turnos/:id',
    loadComponent: () => import('./features/turnos/turno-detail.component').then(m => m.TurnoDetailComponent),
  },
  {
    path: 'funciones',
  ...
  {
    path: 'funciones/:id',
    loadComponent: () => import('./features/funciones/funcion-detail.component').then(m => m.FuncionDetailComponent),
  },
  {
    path: 'proyecciones',
